        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md mt-4 mb-4">
          <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-12 justify-start">
              <button className="px-4 rounded-md text-md border border-gray-950 text-center self-center py-1 my-2 mx-2"> 
                <p className="mx-auto">Lọc</p>
              </button>
              <button className="px-4 bg-gray-200 rounded-md border border-gray-400 hover:bg-cyan-200 text-blue-500 text-md text-center self-center py-1 my-2 mx-2">
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 md:grid-cols-3 lg:grid-cols-5 xl:gap-x-8">
              {laptops.map((laptop) => (
                <div
                ...
                >
                  <Link to={`/productdetail/${laptop.laptop_id}`}>
                    <div className="aspect-h-1 aspect-w-1 w-auto overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-40">
                      <img
                        src={laptop.imageSrc}
